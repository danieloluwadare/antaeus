...
class ValidateMaximumNumberRetriesNotExceededProcessorStateImplTest{
    ...
    fun `get Name Equals START_STATE`() {
        val validateMaximumNumberRetriesExceededProcessorStateImpl = ValidateMaximumNumberRetriesExceededProcessorStateImpl();
        assertEquals(BillProcessorFlowState.VALIDATE_MAXIMUM_NUMBER_RETRIES_EXCEEDED_STATE.name,
